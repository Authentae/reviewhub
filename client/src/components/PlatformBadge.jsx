...
const styles = {
  ...
  retty:       { cls: 'bg-pink-50 dark:bg-pink-900/30 text-pink-700 dark:text-pink-400',             icon: 'R' },
  ...
  holidaycheck:{ cls: 'bg-sky-50 dark:bg-sky-900/30 text-sky-700 dark:text-sky-400',                 icon: '✈' },
