...
export default function Guide() {
  ...
  const steps = [
    {
      ...
      titleTh: 'สมัครฟรี',
      bodyEn: 'Email + password, or one-click with Google or LINE login. No credit card. The Free plan supports 1 business and 3 AI-drafted replies per month — enough to evaluate the product before paying anything.',
      bodyTh: 'ใช้อีเมล+รหัสผ่าน หรือเข้าสู่ระบบด้วย Google/LINE คลิกเดียว ไม่ต้องใช้บัตรเครดิต แพ็กเกจฟรี: 1 ธุรกิจ และคำตอบที่ AI ร่างให้ 3 อันต่อเดือน เพียงพอสำหรับทดลองก่อนจ่ายเงิน',
      ctaEn: 'Sign up →',
      ctaTh: 'สมัคร →',
      ctaTo: '/register',
    },
    ...
    {
      n: '3',
      titleEn: 'Connect LINE for instant alerts',
      titleTh: 'เชื่อม LINE เพื่อแจ้งเตือนทันที',
      bodyEn: 'In Settings → Connect LINE, generate a one-time link code, then send "/link <code>" to the ReviewHub LINE Official Account. From now on, every new Google review pings your LINE chat with the AI-drafted reply ready to send. No need to check Google daily.',
      bodyTh: 'ที่ Settings → เชื่อม LINE สร้างโค้ดเชื่อมบัญชี แล้วส่ง "/link <โค้ด>" ไปที่ LINE Official Account ของ ReviewHub ตั้งแต่นี้รีวิวใหม่จะแจ้งเตือนเข้า LINE คุณทันที พร้อมข้อความตอบกลับที่ AI ร่างไว้แล้ว ไม่ต้องเปิด Google ทุกวัน',
      ctaEn: 'Open Settings →',
      ctaTh: 'ไปที่ Settings →',
      ctaTo: '/settings',
    },
    {
      ...
      titleTh: 'แตะก็อป → วางใน Google',
      bodyEn: 'When a new review pings your LINE, tap the "Copy reply" button on the LINE Flex card. The AI draft is now on your clipboard — open Google, paste, post. Took 30 seconds instead of 30 minutes. (One-tap auto-post launches Q3 2026 when Google approves our Business Profile API access — case 8-9395000041442 submitted 2026-05-09.)',
      bodyTh: 'เมื่อรีวิวใหม่แจ้งเข้า LINE แตะปุ่ม "ก็อปคำตอบ" บน Flex card คำตอบที่ AI ร่างจะถูกก็อปลงคลิปบอร์ด เปิด Google วาง และโพสต์ ใช้เวลา 30 วินาทีแทน 30 นาที (ฟีเจอร์โพสต์อัตโนมัติคลิกเดียว เปิดตัวไตรมาส 3 ปี 2026 เมื่อ Google อนุมัติ Business Profile API)',
      ctaEn: null,
      ctaTh: null,
      ctaTo: null,
    },
  ...
  const flowSteps = [
    ...
    {
      en: 'LINE OA pings you with the review + draft',
      th: 'LINE OA แจ้งเตือนคุณพร้อมรีวิว + ร่างคำตอบ',
    },
    {
  ...
  const faqs = [
    ...
    {
      qEn: 'I missed a LINE notification — is the review lost?',
      qTh: 'พลาดการแจ้งเตือนใน LINE รีวิวหายไหม?',
      aEn: 'No. Every review and its draft also lives on your dashboard at /dashboard. The LINE message is the alert; the dashboard is the system of record. Drafts stay there indefinitely until you reply or delete.',
      aTh: 'ไม่หาย รีวิวและร่างคำตอบทุกอันอยู่ที่ dashboard ของคุณที่ /dashboard ด้วย LINE คือการแจ้งเตือน dashboard คือที่บันทึกถาวร ร่างคำตอบจะอยู่ที่นั่นจนกว่าคุณจะตอบหรือลบ',
    },
    {
