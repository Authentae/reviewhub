...
export default function Guide() {
  ...
  const steps = [
    ...
    {
      n: '4',
      titleEn: 'Copy from LINE → paste in Google',
      titleTh: 'ก็อปจาก LINE → วางใน Google',
      bodyEn: 'When a new review pings your LINE, you receive the Flex card AND a follow-up plain-text message with just the AI draft. Long-press the text message → tap Copy. Tap "Reply on Google" on the Flex card — Google opens directly to your business reviews. Paste the draft, post. 30 seconds instead of 30 minutes. (One-tap auto-post launches Q3 2026 when Google approves our Business Profile API access — case 8-9395000041442 submitted 2026-05-09.)',
      bodyTh: 'เมื่อรีวิวใหม่แจ้งเข้า LINE คุณจะได้รับ Flex card และข้อความตามมาที่มีแค่คำตอบ AI กดค้างที่ข้อความตัวอักษร แล้วแตะ "คัดลอก" แตะปุ่ม "ตอบที่ Google" บน Flex card — Google จะเปิดหน้ารีวิวธุรกิจคุณ วางคำตอบ แล้วโพสต์ ใช้เวลา 30 วินาทีแทน 30 นาที (ฟีเจอร์โพสต์อัตโนมัติคลิกเดียว เปิดตัวไตรมาส 3 ปี 2026 เมื่อ Google อนุมัติ Business Profile API)',
      ctaEn: null,
      ctaTh: null,
      ctaTo: null,
    },
