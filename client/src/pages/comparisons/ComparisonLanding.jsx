...
const COMPARISONS = {
  birdeye: {
    ...
    rows: [
      ...
      { feature: 'LINE OA notifications', us: 'Yes — every new review pings your LINE chat with the AI draft (Bangkok-native)', them: 'No — Slack and email only' },
  ...
  podium: {
    ...
    rows: [
      ...
      { feature: 'LINE OA notifications', us: 'Yes — review + AI draft pings your LINE chat (Bangkok-native)', them: 'No — Slack / SMS / email only' },
  ...
  reviewtrackers: {
    ...
    rows: [
      ...
      { feature: 'LINE OA notifications', us: 'Yes — Bangkok-native messaging channel', them: 'No — Slack / email only' },
  ...
  chatgpt: {
    competitorName: 'ChatGPT (or any general AI)',
    competitorUrl: 'chatgpt.com',
    pageTitle: 'ReviewHub vs ChatGPT — honest comparison',
    title: 'Already using ChatGPT for review replies? Here\'s the honest comparison.',
    eyebrow: 'Comparison · ChatGPT alternative',
    lede: 'ChatGPT (and Claude, Gemini, etc.) write excellent one-shot review replies. The gap isn\'t the AI — it\'s the workflow. ReviewHub uses the same class of models, but wraps them in the operations a busy SMB owner actually needs: automatic ingestion, LINE notifications, edit-learning, and one-tap-to-copy in your LINE chat.',
    competitorPricing: {
      starting: 'Free–$20/mo',
      note: 'ChatGPT Free or Plus ($20/mo). Claude.ai Free or Pro ($20/mo). All assume the owner does the workflow integration manually.',
    },
    pricingDelta: 'ReviewHub is cheaper than ChatGPT Plus ($14 vs $20) AND eliminates the manual ingestion + posting steps — the actual time-cost of the "just use ChatGPT" approach.',
    rows: [
      { feature: 'Cost', us: '$14/mo (or free tier)', them: 'Free–$20/mo' },
      { feature: 'AI quality', us: 'Claude Haiku (Anthropic, 2026 model)', them: 'Same class of models — both excellent' },
      { feature: 'Watches your reviews automatically', us: 'Yes (Google OAuth + 60 platforms via CSV)', them: 'No — you notice + paste each review' },
      { feature: 'Notifications when a review lands', us: 'Yes (LINE OA chat + email)', them: 'No — you check Google manually' },
      { feature: 'Posts to Google', us: 'Tap to copy from LINE → paste in Google (~30s). One-tap auto-post Q3 2026.', them: 'You copy reply back manually anyway' },
      { feature: 'Voice consistency across replies', us: 'Yes (learns from your edits)', them: 'No — each session resets to default' },
      { feature: 'Multi-language tone (Thai / Japanese / Korean)', us: 'Native per-language pragmatics rules', them: 'Generic "translate" quality unless you prompt-engineer it' },
      { feature: 'Anti-corporate-speak rules', us: 'Built into prompt by default', them: 'You re-explain "no \'we sincerely apologize\'" every session' },
      { feature: 'Time per reply (your time)', us: '~30 seconds (LINE → Copy → Paste in Google)', them: '~3-5 minutes (notice + copy + paste + edit + post)' },
      { feature: 'Time-of-reply latency', us: 'Within 30 minutes of review landing (LINE ping)', them: 'Whenever you remember to check' },
      { feature: 'Audit trail / history', us: 'Yes (every reply, who approved, when posted)', them: 'No' },
      { feature: 'Honest fit', us: 'Owners who want the workflow done for them', them: 'Tinkerers who enjoy the manual integration' },
    ],
    pickThemIf: [
      'You enjoy the manual workflow — it gives you a sense of craft and control.',
      'You only get a few reviews per month and the time cost is small.',
      'You\'re comfortable rebuilding the prompt context for each session.',
      'You don\'t want to connect any third-party service to your Google Business Profile.',
    ],
    pickUsIf: [
      'You\'re missing reviews because you didn\'t notice them, not because the AI is bad.',
      'You\'re tired of pasting the same "anti-corporate-speak" prompt every session.',
      'You want the drafts to learn your voice over time without re-prompting.',
      'You operate in Thai / Japanese / Korean and want native-language pragmatics built in, not prompt-engineered.',
    ],
  },

  agency: {
    competitorName: 'a Bangkok marketing agency',
    competitorUrl: 'reviewhub.review/vs/agency',
    pageTitle: 'ReviewHub vs hiring a Bangkok marketing agency — honest comparison',
    title: 'Considering a Bangkok agency for review management? Here\'s the trade-off.',
    eyebrow: 'Comparison · Agency alternative',
    lede: 'Bangkok marketing agencies bundle review management into a "social + reviews + photos + ads" retainer at THB 8,000–25,000/month. ReviewHub is the focused alternative: replies only, in your voice, at $14–59/month. If you also need social and ads, hire the agency. If you just need replies that get posted, you\'re overpaying them by 20-100×.',
    competitorPricing: {
      starting: 'THB 8,000–25,000/mo (~$220–700)',
      note: 'Typical Bangkok small-agency retainer for "social media + review management" bundles. Some include photo shoots and ad management. Pricing varies; we\'re using midrange figures from the Sukhumvit / Thonglor / Asoke agency cluster.',
    },
    pricingDelta: 'ReviewHub starts at $14/mo (~THB 490). For the review-reply workflow alone, that\'s 16-50× cheaper than a typical agency retainer.',
    rows: [
      { feature: 'Starting price', us: '$14/mo (~THB 490)', them: 'THB 8,000–25,000/mo' },
      { feature: 'Reply turnaround', us: 'Within 48h of review landing', them: '1-2 weeks typical (agency batch cycles)' },
      { feature: 'Voice match', us: 'Trained on your edits — sharpens over time', them: 'Generic agency template applied across clients' },
      { feature: 'Who writes the reply', us: 'AI drafts, you approve', them: 'Junior copywriter (often offshore — Philippines / Vietnam)' },
      { feature: 'Thai-native fluency', us: 'Native (Thai pragmatics rules built in)', them: 'Often non-Thai writers — replies sound off' },
      { feature: 'Bundles social media / photos / ads', us: 'No (reviews only)', them: 'Yes (the bundle is the value prop)' },
      { feature: 'You retain ownership of your voice', us: 'Yes — every edit teaches the AI', them: 'No — when you change agency, you lose the institutional memory' },
      { feature: 'Cancellation', us: 'Monthly (cancel anytime)', them: 'Often 3-6 month minimum contracts' },
      { feature: 'LINE OA notifications', us: 'Yes — every review pings your LINE chat with the AI draft', them: 'No — agency emails you a Google Sheet weekly' },
      { feature: 'Posting to Google', us: 'Tap to copy from LINE, paste in Google (~30s). One-tap auto-post Q3 2026.', them: 'Agency posts manually (often delayed by batch cycle)' },
      { feature: 'Honest fit', us: 'Owner who only needs replies handled', them: 'Owner who wants social + ads + reviews bundled' },
    ],
    pickThemIf: [
      'You want a single retainer for social media, photos, ads, AND reviews — and you have THB 10,000+/mo to spend on it.',
      'You prefer human relationships and want a Thai account manager you can text.',
      'You don\'t want to log into anything yourself — the agency handles end-to-end.',
      'You don\'t care if reply turnaround is 1-2 weeks late.',
    ],
    pickUsIf: [
      'You only need review replies handled, not the full social-media bundle.',
      'You want replies posted within 48h of the review, not after the agency\'s batch cycle.',
      'You want the replies to sound like YOU, not like the agency\'s house style.',
      'You\'d rather pay THB 490 than THB 10,000 for the same replies.',
      'You want to keep ownership of your voice training (so it doesn\'t walk out with the agency).',
    ],
  },
};
