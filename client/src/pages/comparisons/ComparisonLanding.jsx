...
const COMPARISONS = {
  ...
  chatgpt: {
    ...
    lede: 'ChatGPT (and Claude, Gemini, etc.) write excellent one-shot review replies. The gap isn\'t the AI — it\'s the workflow. ReviewHub uses the same class of models, but wraps them in the operations a busy SMB owner actually needs: automatic ingestion, edit-learning, and one-tap posting to Google.',
    competitorPricing: {
      starting: 'Free–$20/mo',
    ...
    rows: [
      ...
      { feature: 'Posts to Google on approval', us: 'Yes (Business Profile API)', them: 'No — you copy reply back manually' },
      ...
      { feature: 'Time per reply (your time)', us: '~10 seconds (read + tap Approve)', them: '~3-5 minutes (notice + copy + paste + edit + post)' },
      { feature: 'Time-of-reply latency', us: 'Within 60 seconds of review landing', them: 'Whenever you remember to check' },
  ...
  agency: {
    ...
    rows: [
      ...
      { feature: 'Auto-post to Google', us: 'Yes (one-tap approval)', them: 'Manual (often delayed by agency batch cycle)' },
