# ReviewHub — house rules for Codex
...
`C:\Users\Computer\.Codex\projects\C--Users-Computer-Desktop-App\memory\` — auto-loaded.
...
**1. "Codex design" / "improve visual" = BUILD a visible mockup, not
critique-then-tweak.** When Earth says any flavor of "redesign / use
Codex design / improve visual," the request is for a *visible artifact
...
**3. When asked about other Codex products (cloud / desktop / web),
ask for a screenshot before making capability claims.** I told Earth
"cloud Codex only has 2 modes, no bypass" based on his older session's
...
to "how do I do X in [other Codex]" is *"show me what your menu looks
...
3. If a *recurring pattern* emerged (a foot-gun, a convention, a tool
   discovery), add a memory file to `~/.Codex/projects/.../memory/`
